    ...
    var TempusDominusBootstrap4 = function ($) {
        ...
        var TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
            ...
            _proto2._doAction = function _doAction(e, action) {
                ...
                action = action || $(e.currentTarget).data('action') || $(e.currentTarget).data('wheel');
            ...
            _proto2._doActionWheel = function _doActionWheel(e, action) {
                var lastPicked = this._getLastPickedDate();
                ...
                action = action || $(e.currentTarget).data('wheel');
                ...
                switch (action) {
                    ...
                    case 'incdecHours': {
                        ...
                        if (event.deltaY < 0) {
                            this._doAction(e, 'incrementHours');
                            break;
                        } else if (event.deltaY > 0) {
                            this._doAction(e, 'decrementHours');
                            break;
                        }
                    }
                    ...
                    case 'incdecMinutes': {
                        ...
                        if (event.deltaY < 0) {
                            this._doAction(e, 'incrementMinutes');
                            break;
                        } else if (event.deltaY > 0) {
                            this._doAction(e, 'decrementMinutes');
                            break;
                        }
                    }
                }
            ...
            _proto2.hide = function hide() {
                ...
                this.widget.off('wheel', '[data-wheel]');
            ...
            _proto2.show = function show() {
                ...
                this.widget.on('wheel', '[data-wheel]', $.proxy(this._doActionWheel, this));
